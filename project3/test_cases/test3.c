...
int wb()
{
    if(inst_line[8].buf>-1)
    {
        if(inst_line[8].opcode==255)
        {
            ...
            regs[inst_line[8].dest]=inst_line[8].rleft;
...
void ex2()
{
    if(inst_line[5].buf>-1)
    {
        if(inst_line[5].opcode/16==3)
        {
            if(inst_line[5].opcode%16==1)
            {
                inst_line[5].rleft=regs[inst_line[5].rleft]*inst_line[5].rright;
                ready[inst_line[5].dest]=1;
            }
            else
            {
                inst_line[5].rleft=regs[inst_line[5].rleft]*regs[inst_line[5].rright];
                ready[inst_line[5].dest]=1;
            }
        }
...
void ex1()
{
    if(inst_line[3].buf>-1)
    {
        if(inst_line[3].opcode/16==1)
        {
            if(inst_line[3].opcode%16==1)
            {
                inst_line[3].rleft=regs[inst_line[3].rleft]+inst_line[3].rright;
                ready[inst_line[3].dest]=1;
            }
            else
            {
                inst_line[3].rleft=regs[inst_line[3].rleft]+regs[inst_line[3].rright];
                ready[inst_line[3].dest]=1;
            }
        }
        if(inst_line[3].opcode/16==2)
        {
            if(inst_line[3].opcode%16==1)
            {
                inst_line[3].rleft=regs[inst_line[3].rleft]-inst_line[3].rright;
...
int ia(int data_hazard_count)
{
    if(inst_line[2].buf>-1)
    {
        ...
        else if(inst_line[2].opcode/16<5 && inst_line[1].opcode%16==1 && (ready[inst_line[2].dest]==1 || ready[inst_line[2].rleft]==1))
        {printf("data hazard: %d\n",++data_hazard_count); halt=1;}

        else if(inst_line[2].opcode/16<5 && (ready[inst_line[2].dest]==1 || ready[inst_line[2].rleft]==1 || ready[inst_line[2].rright]==1))
        {printf("data hazard: %d\n",++data_hazard_count); halt=1;}
